...
def test_fk_example_builds_bounded_default_slices():
    args = make_args()
...
def test_fk_example_builds_explicit_slices():
...
def test_fk_example_bandpass_step_uses_processing_service_params():
