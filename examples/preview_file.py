"""Create a metadata summary and waterfall preview for a supported DAS file.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", type=Path, default=Path("das_preview.png"), help="Output image path")
